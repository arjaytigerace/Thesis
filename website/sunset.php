...
<body>
  ...
  <body>
<div class="container-fluid">    
    <center><h1> Sensors' Reading for Sunset Beach Park <i class="fa fa-line-chart" aria-hidden="true"></i></h1></center>
...
<div class="container">
  <table class="table table-bordered" style= "width:250px" align="right">
    ...
    $conn = mysqli_connect("localhost", "root", "", "arduino_thesis");
      ...
      $sql = "SELECT phLevel,dateRet FROM phsensor WHERE ID BETWEEN 185 AND 256";
  ...
  <table class="table table-bordered" style= "width:250px" align="left">
    ...
    $conn = mysqli_connect("localhost", "root", "", "arduino_thesis");
      ...
      $sql = "SELECT tempLevel,dateRet FROM tempsensor WHERE ID BETWEEN 185 AND 256";
      $result = $conn-> query($sql);
  ...
  <table class="table table-bordered" style= "width:250px" align="center">
    ...
    $conn = mysqli_connect("localhost", "root", "", "arduino_thesis");
      ...
      $sql = "SELECT turbLevel,dateRet FROM turbidity WHERE ID BETWEEN 185 AND 256";
      $result = $conn-> query($sql);
