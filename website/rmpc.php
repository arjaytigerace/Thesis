...
<body>
                ...
                <ul class="navbar-nav mr-auto">
                  ...
                  <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="#" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                      RMPC Resort and Training Center
                    </a>
                    <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                      ...
                      <a class="dropdown-item" href="sunset.php">Sunset Beach Park</a>
                       <a class="dropdown-item" href="seagrass.php">Sea Grass Beach Resort</a>
  ...
  <body>
<div class="container-fluid">    
    <center><h1> Sensors' Reading for RMPC Resort and Training Center <i class="fa fa-line-chart" aria-hidden="true"></i></h1></center>
...
<div class="container">
  <table class="table table-bordered" style= "width:250px" align="right">
    ...
    $conn = mysqli_connect("localhost", "root", "", "arduino_thesis");
      ...
      $sql = "SELECT phLevel,dateRet FROM phsensor WHERE ID BETWEEN 257 AND 280";
  ...
  <table class="table table-bordered" style= "width:250px" align="left">
    ...
    $conn = mysqli_connect("localhost", "root", "", "arduino_thesis");
      ...
      $sql = "SELECT tempLevel,dateRet FROM tempsensor WHERE ID BETWEEN 257 AND 280";
      $result = $conn-> query($sql);
  ...
  <table class="table table-bordered" style= "width:250px" align="center">
    ...
    $conn = mysqli_connect("localhost", "root", "", "arduino_thesis");
      ...
      $sql = "SELECT turbLevel,dateRet FROM turbidity WHERE ID BETWEEN 257 AND 280";
      $result = $conn-> query($sql);
