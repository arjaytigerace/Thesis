...
<body>
  ...
  <body>
<div class="container-fluid">    
    <center><h1> Sensors' Reading for Plaza Azelea Beach Resort <i class="fa fa-line-chart" aria-hidden="true"></i></h1></center>
...
<div class="container">
  <table class="table table-bordered" style= "width:250px" align="right">
    ...
    $conn = mysqli_connect("localhost", "root", "", "arduino_thesis");
      ...
      $sql = "SELECT phLevel,dateRet FROM phsensor WHERE ID BETWEEN 119 AND 151";
  ...
  <table class="table table-bordered" style= "width:250px" align="left">
    ...
    $conn = mysqli_connect("localhost", "root", "", "arduino_thesis");
      ...
      $sql = "SELECT tempLevel,dateRet FROM tempsensor WHERE ID BETWEEN 119 AND 151";
      $result = $conn-> query($sql);
  ...
  <table class="table table-bordered" style= "width:250px" align="center">
    ...
    $conn = mysqli_connect("localhost", "root", "", "arduino_thesis");
      ...
      $sql = "SELECT turbLevel,dateRet FROM turbidity WHERE ID BETWEEN 119 AND 151";
      $result = $conn-> query($sql);
