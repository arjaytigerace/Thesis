...
<head>
      ...
      <!---CHANGE NAV COLOR TO BLUE FROM BLACK----->
          <!---CHANGE NAV COLOR TO BLUE FROM BLACK----->
              <!---CHANGE NAV COLOR TO BLUE FROM BLACK----->
                  <!---CHANGE NAV COLOR TO BLUE FROM BLACK----->
                      <!---CHANGE NAV COLOR TO BLUE FROM BLACK----->
  ...
  <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="#" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                     ...
                     <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                      <a class="dropdown-item" href="tempgraph.php">Temperature</a>
                      <a class="dropdown-item" href="turbgraph.php">Turbidity</a>
                  </div>
                </li>
...
<!----Database Connection and Data Assigning to Columns ---->
...
FROM phsensor WHERE id between 34 AND 280
...
// fetching of data in Database and Data Assignment for data display 
...
<html>
 ...
 <body>
  <div class="page-wrapper">
   <br />
   <h2 align="center">ph Level Level Graph </h2>
