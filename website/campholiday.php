...
<body>
                ...
                <ul class="navbar-nav mr-auto">
                  ...
                  <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                      ...
                      <a class="dropdown-item" href="seagrass.php">Sea Grass</a>
  ...
  <body>
<div class="container-fluid">    
    <center><h1> Sensors' Reading for Camp Holiday Beach Resort <i class="fa fa-line-chart" aria-hidden="true"></i></h1></center>
...
<div class="container">
  <table class="table table-bordered" style= "width:250px" align="right">
    ...
    $conn = mysqli_connect("localhost", "root", "", "arduino_thesis");
      ...
      $sql = "SELECT phLevel,dateRet FROM phsensor WHERE ID BETWEEN 152 AND 184";
  ...
  <table class="table table-bordered" style= "width:250px" align="left">
    ...
    $conn = mysqli_connect("localhost", "root", "", "arduino_thesis");
     ...
     $sql = "SELECT tempLevel,dateRet FROM tempsensor WHERE ID BETWEEN 152 AND 184";
      $result = $conn-> query($sql);
  ...
  <table class="table table-bordered" style= "width:250px" align="center">
    ...
    $conn = mysqli_connect("localhost", "root", "", "arduino_thesis");
     ...
     $sql = "SELECT turbLevel,dateRet FROM turbidity WHERE ID BETWEEN 152 AND 184";
      $result = $conn-> query($sql);
