                    ...
                    <a class="nav-link dropdown-toggle" href="#" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                     ...
                     <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                      ...
                      <a class="dropdown-item" href="plazagraph.php">Plaza Azelea</a>
                       <a class="dropdown-item" href="campgraph.php">Camp Holiday</a>
...
FROM phsensor WHERE id between 257 AND 280
...
UNIX_TIMESTAMP(dateRet) AS datetime 
FROM tempsensor WHERE id between 257 AND 280
ORDER BY dateRet DESC';
$result = mysqli_query($connect, $query);
$rows = array();
$table = array();
...
UNIX_TIMESTAMP(dateRet) AS datetime 
FROM turbidity WHERE id between 257 AND 280
ORDER BY dateRet DESC';
$result = mysqli_query($connect, $query);
$rows = array();
$table = array();
